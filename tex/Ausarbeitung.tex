...
% -------------------------------------------------------
\section{Einleitung}
Im 21. Jahrhundert haben sich zwei große Trends herauskristallisiert, die unser Leben verändern: Urbanisierung und digitale Transformation. 
Urbanisierung bedeutet, dass mehr Menschen in die Städte ziehen, während die digitale Transformation neue Technologien nutzt, um Systeme und Prozesse zu verbessern. \autocite[S. 2f]{zhang_trends_2015}
Diese beiden Trends sind eng miteinander verknüpft - die Urbanisierung erhöht den Bedarf an Innovationen, und digitale Technologien helfen, die Herausforderungen der Städte zu lösen.
